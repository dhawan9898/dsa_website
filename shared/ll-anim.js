...
(function(window){
  ...
  function injectCSS(){
    ...
    var css=[
      ...
      ".ll-node.bucket .ll-val{background:var(--ink,#1C2B24);color:#fff;font-weight:700}",
      ".ll-node.bucket .ll-nextcell{background:#eef2e6}",
      ".ll-node.bucket.active .ll-val{background:var(--stamp,#BE3A1D)}",
      ".ll-node.bucket.active .ll-nextcell,.ll-node.bucket.active .ll-val{border-color:var(--stamp,#BE3A1D)}",
